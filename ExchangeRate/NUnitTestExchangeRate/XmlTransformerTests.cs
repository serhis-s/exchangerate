...
namespace Tests
{
    public class XmlResponseTransformerCbrTests
    {
        ...
        [Test]
        public void TransformShouldReturnGoodExpectedResult2()
        {
            var expectedValue = " ошибка = Unexpected end of file has occurred. The following elements are not closed: Valute, ValCurs. Line 16, position 17. иcточник= http://ya.ru";
            var xmlResponseTransformer = new XmlResponseTransformerCbr();
            var exchangeRateSource = new ExchangeRateSource
            {
                Url = "http://ya.ru",
